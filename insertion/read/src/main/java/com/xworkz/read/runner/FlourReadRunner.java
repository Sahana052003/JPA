...
public class FlourReadRunner {
    public static void main(String[] args) {
        ...
        com.xworkz.insertion.entity.BakeryEntity bakeryEntity1 = entityManager.find(com.xworkz.insertion.entity.BakeryEntity.class, 5);
